    ...
    plans = [
        ...
        },
        {
            ...
            'features': [
                ...
                'TeamGuard (bis 20 Mitarbeiter)',
                'Phishing-Simulation',
                'API-Zugang',
                'PDF-Berichte',
                'Prioritäts-Support',
                '🛡️ NIS2 Compliance Plattform (§30 BSIG)',
                '   → KI-ISMS-Dokumentengenerator (7 Docs)',
                '   → BSI-Registrierungs-Assistent (§33)',
                '   → Incident Response + BSI-Meldungen',
                '   → Lieferkettensicherheit + Monitoring',
                '   → Awareness-Schulungen + Audit-Berichte',
            ],
