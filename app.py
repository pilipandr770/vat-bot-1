from application import create_appimport os

from flask import Flask, render_template, request, jsonify, flash, redirect, url_for

app = create_app()from flask_migrate import Migrate

from flask_login import LoginManager, login_required, current_user

if __name__ == '__main__':from flask_mail import Mail

    app.run()from config import config
...
def create_app(config_name=None):
    ...
    # Initialize mailguard models with the app's db
    from app.mailguard.models import db as mailguard_db
    mailguard_db.init_app(app)
